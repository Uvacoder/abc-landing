<template>
  ...
  <div
    ...
    class="p-4 space-y-1 bg-gray-100 rounded-md ring-1 ring-gray-200"
  >
    <div class="flex items-center justify-between">
      <div
        class="w-7/12 h-5 bg-gray-300 rounded-md animate-pulse"
      />

      <div
        class="w-2/12 h-5 bg-gray-300 rounded-md animate-pulse"
      />
    </div>

    <div class="w-full h-4 bg-gray-300 rounded-md" />
    <div class="w-4/12 h-4 bg-gray-300 rounded-md" />
  </div>
